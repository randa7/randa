        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="KokeRu"
              description="A software to assist building managers in controlling the cleanliness and tidiness of the building which is the responsibility of each Cleaning Service so that it can be run more efficiently without having to check directly in each room."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="CaritaKita"
              description="dynamic blog website that allows users to post posts with several categories provided. this website was developed with native php and vanilla js."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description=" Used the BBC text dataset from laurencemoroney-blog and trained a NLP model using 'Keras' framework using LSTM . The model was successfully able to build a system that can accurately classify previously unseen news articles into appropriate categories."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Used the energy data dataset from UCI and trained a Time series model using 'Keras' framework using LSTM . The model was successfully able to build a system that can forecast temperature accurately based on predetermined timeframe."
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="Trained a CNN classifier using 'rockpaperscissors dataset' with Keras and tensorflow backened. The classifier sucessfully predicted the shape of rock paper scissors and the highest accuracy obtained with the model was 97.5%."
